...
ARG ME_CONFIG_MONGODB_ENABLE_ADMIN
ARG ME_CONFIG_MONGODB_SSL
ARG ME_CONFIG_SITE_COOKIESECRET
ARG ME_CONFIG_SITE_SESSIONSECRET
ARG ME_CONFIG_BASICAUTH
ARG ME_CONFIG_BASICAUTH_USERNAME
ARG ME_CONFIG_BASICAUTH_PASSWORD
ARG MONGOexpressPort
ARG MONGODBName
#ENV
...
RUN echo $ME_CONFIG_MONGODB_URL
